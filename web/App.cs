...
namespace web {
    public class App
    {
        ...
        public static async Task<IList<IDictionary<string, object>>> QuerySysConvAsync([LCEngineFunctionParam("total")] int total, [LCEngineFunctionParam("convName")] string convName)
        {
