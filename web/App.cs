...
namespace web {
    public class App
    {
        ...
        public static async Task<IDictionary<string, IDictionary<string, object>>> QuerySysConvAsync([LCEngineFunctionParam("total")] int total, [LCEngineFunctionParam("convName")] string convName)
        {
